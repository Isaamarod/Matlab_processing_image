%function_fuzzy_2_colormap_loop('..\imags_E_S\','..\imags_E_S\fuzzy_2colormap_test_FCM','*.jpg',5)
function function_fuzzy_2_colormap_loop (filename_input,filename_output,file_pattern,num_clusters)
