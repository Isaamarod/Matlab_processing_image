%https://www.mathworks.com/matlabcentral/answers/323816-i-want-to-extract-skull-from-brain-mri-using-morphological-operations-but-i-didnt-get-a-useful-out
...
[filename pathname] = uigetfile({'*.png';'*.jpg';'*.bmp'},'Select MRI');
inputimage=strcat(pathname, filename);
baseFileName = filename;
% baseFileName = 'sc4.jpg';
% Get the full filename, with path prepended.
folder = pwd;
%fullFileName = fullfile(folder, inputimage);
fullFileName=inputimage;
