%function_FCM_grayimg_loop('C:\Users\cober\Documents\Matlab_processing_image\imags_E_S','C:\Users\cober\Documents\Matlab_processing_image\imags_E_S\fuzzy_gray_test_FCM','*.jpg',2)
function function_FCM_grayimg_loop(filename_input,filename_output,file_pattern,num_clusters)
...
filePattern = fullfile(filename_input, file_pattern);
jpegFiles = dir(filePattern); %todas las imagenes jpg
%patron imagenes salida
filePattern_2 = fullfile(filename_output, file_pattern);
