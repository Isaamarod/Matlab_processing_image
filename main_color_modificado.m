...
clear all   
%% parameters
filename_output='C:\Users\cober\Desktop\prueba_matlab';%ruta imagenes salida
...
%% test a color image
fileID='colormap';
f_ori=imread('C:\Users\cober\Desktop\salida_prueba_colormap_2.jpg');
...
colormap default
imshow(f_seg);
export_fig('C:\Users\cober\Desktop\salida_prueba_colormap_2_fuzzy_cluster_7_probando_add_path.jpg')
%nombre_salida_p='colomap_blur_20_RBG_-100_test_con-018.jpg';
%nombre_salida=strcat('fuzzy_','cluster_',cluster,nombre_salida_p);

%fullFileName_o = fullfile(filename_output, nombre_salida);
%imwrite(f_ori,filename_output);
...
colormap default
imshow(f_seg);
export_fig('C:\Users\cober\Desktop\salida_prueba_colormap_2_fuzzy_cluster_7_probando_add_path_INMOISE.jpg')
%nombre_salida_p='colomap_blur_20_RBG_-100_test_con-018.jpg';
%nombre_salida=strcat('fuzzy_','cluster_',cluster,nombre_salida_p);
